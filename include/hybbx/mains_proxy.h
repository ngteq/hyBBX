...
/**
 * Main-to-Main mesh proxy — link two or more HyBBX Main instances.
 *
 ...
 *
 * Implementation is stubbed; see plugins/mains_proxy/.
 */
...
/**
 * Register peers and start mesh (stub — logs planned HBX circuit links only).
 * Existing mesh state is replaced when called again while running.
 */
...
/** Periodic mesh I/O (stub). Call from service main loop when running. */
